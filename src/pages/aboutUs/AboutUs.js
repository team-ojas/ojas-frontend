    ...
    <div>
      ...
      <div className="about-text">
        ...
        <p>
          ...
          get a chance to turn their dreams into reality. We have also won the prize in “Best Event Execution” category in NIMBUS 2021.</p>
        ...
        <div className="profile-box">
          ...
          <h3 className='cc-name'>Gaurav
            <div className='socials'>
              <a href="google.com" className="fa-brands fa-instagram"></a>
              <a href="google.com" className="fa-brands fa-linkedin"></a>
            </div>
          </h3>
        </div>
        <div className="profile-box">
